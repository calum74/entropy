...
\Procedure{combine\_uniform}{$U_n, n, U_m, m$} 
...
\Procedure{divide\_uniform}{$U_{nm}, nm, m$} 
...
\Ensure $U_s \indep W$
\Procedure{generate\_weighted}{$U_s, s, weights, outputs, offsets$} 
...
Lemire (alias method) & $Bernoulli\{\frac{1}{100}\}$ &  &  \\
...
Lemire (alias method) & $Weighted\{1,2,3,4,5\}$ &  &  \\
