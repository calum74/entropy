...
\begin{proof}
As $s_{min} \rightarrow \infty$, $p = \frac{n-1}{s_{min}} \rightarrow 0$. $p\log_2p \rightarrow 0$ as $p \rightarrow 0$ by applying L'H\^opital's Rule, therefore $\epsilon_{max} \rightarrow 0$ in Equation \ref{eq:epsilon-max}. In Equation \ref{eq:generate-uniform-efficiency}, $\eta_{min} \rightarrow 1$ as $\epsilon_{max} \rightarrow 0$.
\end{proof}
